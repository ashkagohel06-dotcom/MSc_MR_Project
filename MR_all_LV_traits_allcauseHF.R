...
for (trait in lv_traits) {
  ...
  out_full <- fread("C:/Users/HP/Documents/msc_project/input/HF_Data/HF_Data/allcause_HF_GCST90726617.tsv") %>%
    as.data.frame()
...
write.xlsx(
  final_output,
  "C:/Users/HP/Documents/msc_project/output/all_LV_traits_IVW_results_allcauseHF.xlsx",
  overwrite = TRUE
)
